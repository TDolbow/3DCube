...
var = tkinter.IntVar()
label4 = tkinter.Checkbutton(top,text="occlusion", variable=var)
label4.pack()
    ...
    if(occ == 0):
        for x in range(6):
            if sort[x] == cube1.getFrontSideZAvg():
                c.create_polygon(Front,outline="red", fill = "")
            if sort[x] == cube1.getLeftSideZAvg():
                c.create_polygon(Left,outline = "red", fill = "")
            if sort[x] == cube1.getRightSideZAvg():
                c.create_polygon(Right,outline="red", fill="")
            if sort[x] == cube1.getBottomSideZAvg():
                c.create_polygon(Bottom, outline="red", fill = "")
            if sort[x] == cube1.getTopSideZAvg():
                c.create_polygon(TopS,outline="red", fill = "")
            if sort[x] == cube1.getBackSideZAvg():
                c.create_polygon(Back,outline="red",fill = "")
    else:
        for x in range(6):
            if sort[x] == cube1.getFrontSideZAvg():
                c.create_polygon(Front,outline="red", fill = "red")
            if sort[x] == cube1.getLeftSideZAvg():
                c.create_polygon(Left,outline = "red", fill = "green")
            if sort[x] == cube1.getRightSideZAvg():
                c.create_polygon(Right,outline="red", fill="blue")
            if sort[x] == cube1.getBottomSideZAvg():
                c.create_polygon(Bottom, outline="red", fill = "yellow")
            if sort[x] == cube1.getTopSideZAvg():
                c.create_polygon(TopS,outline="red", fill = "orange")
            if sort[x] == cube1.getBackSideZAvg():
                c.create_polygon(Back,outline="red",fill = "teal")
